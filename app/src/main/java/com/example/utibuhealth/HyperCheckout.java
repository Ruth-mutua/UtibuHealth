...
public class HyperCheckout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hyper_checkout);
        ...
        btnMakeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isApproved) {
                    ...
                    Toast.makeText(HyperCheckout.this, "Order placed successfully", Toast.LENGTH_SHORT).show();
                } else {
                    // Quantity exceeds limits, decline the order
                    String status = "Declined";
                    makeOrder(itemName, emailAddress, quantity, price, status);
                    Toast.makeText(HyperCheckout.this, "Quantity exceeds limits, order declined", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
