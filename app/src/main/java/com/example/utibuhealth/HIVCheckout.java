...
public class HIVCheckout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hivcheckout);
        ...
        btnMakeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isApproved) {
                    ...
                    Toast.makeText(HIVCheckout.this, "Order placed successfully", Toast.LENGTH_SHORT).show();
                } else {
                    // Quantity exceeds limits, decline the order
                    String status = "Declined";
                    makeOrder(itemName, emailAddress, quantity, price, status);
                    Toast.makeText(HIVCheckout.this, "Quantity exceeds limits, order declined", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
